...
export default function EditStoryScreen({ route }: RecordScreenProps<'EditStory'>) {
  return (
    <SafeAreaView style={styles.root}>
      <View style={styles.content}>
        <Text style={styles.title}>Edit Story</Text>
        <Text style={styles.subtitle}>Trim your recording — coming soon</Text>
        <Text style={styles.meta}>Duration: {route.params.durationMs}ms</Text>
      </View>
    </SafeAreaView>
  )
}
